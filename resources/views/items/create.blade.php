...
<html lang="en">
    <head>
        ...
        <title>Tambah Data | Exercise 6</title>
    ...
    <body id="page-top">
        ...
        <section style="min-height:100vh;"class="masthead-content pt-5">
            <div class="container px-5 col-6 mt-5 pt-5">
                <h1 class="mb-1 fs-2 text-center">Form Tambah Data</h1>
                <hr class="mb-4">
        <form action="{{ route('store') }}" method="POST" class="mb-5">
            @csrf
            <div class="mb-3">
                <label for="AddTitle" class="form-label">Judul Buku</label>
                <input required type="text" id="AddTitle" name="name" placeholder="Isikan Judul Buku" class="form-control">
            </div>
            <div class="row mb-3">
                <div class="col">
                ...
                <div class="col">
                    ...
                    <input required type="text" class="form-control" id="addYear" placeholder="Tahun berapa gan?" name="tahun">
                </div>
            </div>
            <div class="mb-3">
                <label for="AddDesk" class="form-label">Deskripsi</label>
                <textarea required id="AddDesk" name="desc" class="form-control" placeholder="Isikan deskripsi biar ga kocong"></textarea>
            </div>
            <div class="row mt-5">
