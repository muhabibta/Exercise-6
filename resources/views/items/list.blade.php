...
<html lang="en">
    <head>
        ...
        <title>List Buku | Exercise 6</title>
        ...
        <section style="min-height:100vh;"class="masthead-content pt-5">
            <div class="container px-5 mt-5 pt-5">
                <div class="d-flex justify-content-between">
                    <h1 class="mb-1 fs-2">Data Buku</h1>
                    <a href="{{ route('list_genre') }}" class="btn btn-primary add ms-auto rounded-pill px-5">
                        List Genre
                    </a>
                </div>
                <hr class="mb-4">
                ...
                <table class="table table-striped table-hover table-borderless">
                    <thead id="table-head">
                        <tr>
                            ...
                            <th class="text-center me-5">Genre</th>
                            <th class="text-center me-5">Tahun</th>
                            <th class="text-center me-5">Deskripsi</th>
                ...
                <div class="col-3 ms-auto">
                    <a href="{{ route('create') }}" class="btn btn-primary add ms-auto rounded-pill px-5 me-5">
                        Tambah Data
                    </a>
                </div>
            </div>
